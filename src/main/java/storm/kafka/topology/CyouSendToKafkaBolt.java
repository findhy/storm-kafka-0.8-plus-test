...
public class CyouSendToKafkaBolt extends BaseRichBolt {
	...
	public static Logger LOG = LoggerFactory.getLogger(CyouSendToKafkaBolt.class);
	OutputCollector _collerctor;
	Producer<String, String> producer;

	public CyouSendToKafkaBolt() {
